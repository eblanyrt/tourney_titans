...
<html lang="en">
  ...
  <body>
    ...
    <table class="table table-success table-striped">
      ...
      <?php
        $query = mysqli_query($conn, "SELECT * FROM allrank");
      ...
      <tr>
        ...
        <td>
          <a href="../receipt_pembayaran/allrank/<?php echo $row['receipt_pembayaran'] ?>">
            <?php echo $row['receipt_pembayaran'] ?></td>
          </a>
        <td> 
          <a href="../gambar_upload/allrank/<?php echo $row['bukti_transfer'] ?>">
            <img src="../gambar_upload/allrank/<?php echo $row['bukti_transfer'] ?>" height="100px" width="100px">
          </a>
        </td>
        <td>
          <a href="hapus.php?id=<?php echo $row['id']; ?>&nama_tabel=allrank&nama_halaman=allrank_tampilan">Hapus</a> |
          <a href="ubahdata_tournament.php?id=<?php echo $row['id']; ?>&nama_tabel=allrank&nama_halaman=allrank_tampilan">Ubah</a>
        </td>
      </tr>
      <?php } ?>
