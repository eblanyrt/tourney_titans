...
<html lang="en">
  ...
  <body>
    ...
    <table class="table table-success table-striped">
      ...
      <?php
        $query = mysqli_query($conn, "SELECT * FROM archon");
      ...
      <tr>
        ...
        <td>
          <a href="../receipt_pembayaran/archon/<?php echo $row['receipt_pembayaran'] ?>">
            <?php echo $row['receipt_pembayaran'] ?></td>
          </a>
        <td> 
          <a href="../gambar_upload/archon/<?php echo $row['bukti_transfer'] ?>">
            <img src="../gambar_upload/archon/<?php echo $row['bukti_transfer'] ?>" height="100px" width="100px">
          </a>
        </td>
        <td>
          <a href="hapus.php?id=<?php echo $row['id']; ?>&nama_tabel=archon&nama_halaman=archon_tampilan">Hapus</a> |
          <a href="ubahdata_tournament.php?id=<?php echo $row['id']; ?>&nama_tabel=archon&nama_halaman=archon_tampilan">Ubah</a>
        </td>
      </tr>
      <?php } ?>
