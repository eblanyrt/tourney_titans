...
<html lang="en">
  <head>
    ...
    <!-- Judul Website  -->
    <title>HALAMAN ADMIN - Croox Organizer</title>
  ...
  <body>
    ...
    <table class="table table-success table-striped">
      ...
      <?php
        $query = mysqli_query($conn, "SELECT * FROM mixteam");
        while($row = mysqli_fetch_array($query)){
      ?>
      <tr>
        <td><?php echo $row['email'] ?></td>
        <td><?php echo $row['steam_link'] ?></td>
        ...
        <td>
          <a href="../receipt_pembayaran/mixteam/<?php echo $row['receipt_pembayaran'] ?>">
            <?php echo $row['receipt_pembayaran'] ?></td>
          </a>
        <td> 
          <a href="../gambar_upload/mixteam/<?php echo $row['bukti_transfer'] ?>">
            <img src="../gambar_upload/mixteam/<?php echo $row['bukti_transfer'] ?>" height="100px" width="100px">
          </a>
        </td>
        <td>
          <a href="hapus.php?id=<?php echo $row['id']; ?>&nama_tabel=mixteam&nama_halaman=mixteam_tampilan">Hapus</a> |
          <a href="ubahdata_mixteam.php?id=<?php echo $row['id']; ?>&nama_tabel=mixteam&nama_halaman=mixteam_tampilan">Ubah</a>
        </td>
      </tr>
      <?php } ?>
