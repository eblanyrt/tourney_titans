...
<html lang="en">
  ...
  <body>
    ...
    <div class="header" data-aos="fade">
      <center>
        <img src="../poster_turnamen/poster3.png">
      </center>
      <br>
    ...
    <?php
      if(isset($_POST['submit'])){
        ...
        $folder_receipt = '../receipt_pembayaran/legend/';
        ...
        $folder = '../gambar_upload/legend/';
        move_uploaded_file($source, $folder.$bukti_transfer);

        $insert = mysqli_query($conn, "INSERT INTO legend (nama_tim, email, nomor_wa, steam_link1, steam_link2, steam_link3, steam_link4, steam_link5, steam_link6, slot, medal_anggota, receipt_pembayaran,bukti_transfer) VALUES ('$nama_tim', '$email', '$nomor_wa', '$steam_link1', '$steam_link2', '$steam_link3', '$steam_link4', '$steam_link5', '$steam_link6', '$slot', '$medal_anggota', '$receipt_pembayaran','$bukti_transfer')");
