...
<html lang="en">
  ...
  <body>
    ...
    <div class="header" data-aos="fade">
      <center>
        <img src="../poster_turnamen/poster1.png">
      </center>
      <br>
    ...
    <?php
      if(isset($_POST['submit'])){
        ...
        $folder_receipt = '../receipt_pembayaran/allrank/';
        ...
        $folder = '../gambar_upload/allrank/';
        move_uploaded_file($source, $folder.$bukti_transfer);

        $insert = mysqli_query($conn, "INSERT INTO allrank (nama_tim, email, nomor_wa, steam_link1, steam_link2, steam_link3, steam_link4, steam_link5, steam_link6, slot, medal_anggota, receipt_pembayaran,bukti_transfer) VALUES ('$nama_tim', '$email', '$nomor_wa', '$steam_link1', '$steam_link2', '$steam_link3', '$steam_link4', '$steam_link5', '$steam_link6', '$slot', '$medal_anggota', '$receipt_pembayaran','$bukti_transfer')");
        ...
        <table align="center" style="margin-left:auto; margin-right:auto" >
          ...
          <tr>
            ...
            <td> 
              ...
              <input type="checkbox" name="medal_anggota[]" id="medal_anggota" value="Legend"/>Legend<br />
              <input type="checkbox" name="medal_anggota[]" id="medal_anggota" value="Ancient"/>Ancient<br />
              <input type="checkbox" name="medal_anggota[]" id="medal_anggota" value="Divine"/>Divine<br />
              <input type="checkbox" name="medal_anggota[]" id="medal_anggota" value="Immortal"/>Immortal<br />
            </td>
          </tr>
          <tr>  
